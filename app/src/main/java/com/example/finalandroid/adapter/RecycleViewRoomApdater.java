...
public class RecycleViewRoomApdater extends RecyclerView.Adapter<RecycleViewRoomApdater.RoomViewHolder>{
    private List<Room> mList;
    private ItemListener itemListener;

    public RecycleViewRoomApdater() {
        mList = new ArrayList<>();
    }
    ...
    @NonNull
    @Override
    public RecycleViewRoomApdater.RoomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room, parent, false);
        return new RecycleViewRoomApdater.RoomViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewRoomApdater.RoomViewHolder holder, int position) {
    ...
    public class RoomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private TextView tvPrice, tvTitle, tvDis;
