...
public class RecycleViewHotelHomeStarAdapter extends RecyclerView.Adapter<RecycleViewHotelHomeStarAdapter.HotelViewHolder>{
    private List<Hotel> mList;
    private ItemListener itemListener;

    public RecycleViewHotelHomeStarAdapter() {
        mList = new ArrayList<>();
    }
    ...
    public HotelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hotel_home_star, parent, false);
    ...
    public class HotelViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            if(itemListener != null){
                itemListener.onItemClickHotel(view, getAdapterPosition());
            }
        }
    }

    public interface ItemListener{
        void onItemClickHotel(View view, int position);
    }
}
